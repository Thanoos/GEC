...
func TestIsHexAddress(t *testing.T) {
	tests := []struct {
		...
		{"G15aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"G15aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"G1AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"G1AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"G15aaeb6053f3e94c9b9a09f33669435e7ef1beaed1", false},
		{"G15aaeb6053f3e94c9b9a09f33669435e7ef1beae", false},
		{"5aaeb6053f3e94c9b9a09f33669435e7ef1beaed11", false},
		{"G1xaaeb6053f3e94c9b9a09f33669435e7ef1beaed", false},
	}
...
func TestAddressUnmarshalJSON(t *testing.T) {
	var tests = []struct {
		...
		{`"G1"`, true, nil},
		{`"G100"`, true, nil},
		{`"G1G000000000000000000000000000000000000000"`, true, nil},
		{`"G10000000000000000000000000000000000000000"`, false, big.NewInt(0)},
		{`"G10000000000000000000000000000000000000010"`, false, big.NewInt(16)},
	}
...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		{"G15aaeb6053f3e94c9b9a09f33669435e7ef1beaed", "G15aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed"},
		{"G1fb6916095ca1df60bb79ce92ce3ea74c37c5d359", "G1fB6916095ca1df60bB79Ce92cE3Ea74c37c5d359"},
		{"G1dbf03b407c01e7cd3cbea99509d93f8dddc8c6fb", "G1dbF03B407c01E7cD3CBea99509d93f8DDDC8C6FB"},
		{"G1d1220a0cf47c7b9be7a2e6ba89f429762e7b9adb", "G1D1220A0cf47c7B9Be7A2E6BA89F429762e7b9aDb"},
		// Ensure that non-standard length input values are handled correctly
		{"0xa", "G1000000000000000000000000000000000000000A"},
		{"0x0a", "G1000000000000000000000000000000000000000A"},
		{"0x00a", "G1000000000000000000000000000000000000000A"},
		{"0x000000000000000000000000000000000000000a", "G1000000000000000000000000000000000000000A"},
	}
	for i, test := range tests {
